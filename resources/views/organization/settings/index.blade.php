    ...
    <div class="layout-px-spacing">
        <div class="row layout-top-spacing">
            ...
            <div class="col-xl-12 col-lg-12 col-sm-12 layout-spacing mt-4">
                <div class="widget widget-chart-one">
                    <div class="widget-heading">
                        <h5 class="mb-0">تنظیمات فاکتور</h5>
                    </div>
                    <div class="widget-content">
                        <!-- Invoice Settings Section -->
                        <div class="card">
                            <div class="card-header bg-success text-white">
                                <h5 class="mb-0">
                                    <i class="fa fa-file-invoice"></i> قالب شماره فاکتور
                                </h5>
                            </div>
                            <div class="card-body">
                                <!-- Help Section -->
                                ...
                                <div class="card bg-light mb-4">
                                    <div class="card-body text-center">
                                        <label class="text-muted mb-2 d-block">پیش‌نمایش قالب:</label>
                                        <div class="preview-container" style="min-height: 60px; display: flex; align-items: center; justify-content: center;">
                                            <div id="invoice-format-preview" class="h4 mb-0 text-success font-weight-bold" style="font-family: 'Courier New', monospace; letter-spacing: 2px;">
                                                <span class="text-muted">هیچ قالبی تعریف نشده است</span>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="mb-4">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <div class="row">
                                            <div class="col-md-3 col-sm-6 mb-2">
                                                <button type="button" class="btn btn-outline-primary btn-block add-invoice-part-btn" data-type="increment">
                                                    <i class="fa fa-sort-numeric-up"></i><br>
                                                    <small>عدد افزایشی</small>
                                                </button>
                                            </div>
                                            <div class="col-md-3 col-sm-6 mb-2">
                                                <button type="button" class="btn btn-outline-info btn-block add-invoice-part-btn" data-type="day">
                                                    <i class="fa fa-calendar-day"></i><br>
                                                    <small>عدد روز</small>
                                                </button>
                                            </div>
                                            <div class="col-md-3 col-sm-6 mb-2">
                                                <button type="button" class="btn btn-outline-info btn-block add-invoice-part-btn" data-type="day_name">
                                                    <i class="fa fa-calendar-week"></i><br>
                                                    <small>نام روز</small>
                                                </button>
                                            </div>
                                            <div class="col-md-3 col-sm-6 mb-2">
                                                <button type="button" class="btn btn-outline-success btn-block add-invoice-part-btn" data-type="month">
                                                    <i class="fa fa-calendar-alt"></i><br>
                                                    <small>نام ماه</small>
                                                </button>
                                            </div>
                                            <div class="col-md-3 col-sm-6 mb-2">
                                                <button type="button" class="btn btn-outline-success btn-block add-invoice-part-btn" data-type="month_number">
                                                    <i class="fa fa-calendar"></i><br>
                                                    <small>عدد ماه</small>
                                                </button>
                                            </div>
                                            <div class="col-md-3 col-sm-6 mb-2">
                                                <button type="button" class="btn btn-outline-danger btn-block add-invoice-part-btn" data-type="year">
                                                    <i class="fa fa-calendar-check"></i><br>
                                                    <small>سال</small>
                                                </button>
                                            </div>
                                            <div class="col-md-3 col-sm-6 mb-2">
                                                <button type="button" class="btn btn-outline-warning btn-block add-invoice-part-btn" data-type="text">
                                                    <i class="fa fa-font"></i><br>
                                                    <small>متن</small>
                                                </button>
                                            </div>
                                    ...
                                    <div class="mb-3">
                                        <label class="text-muted mb-2 d-block">ترتیب بخش‌ها:</label>
                                        <div id="invoice-format-parts-container" class="format-parts-container" style="min-height: 80px; padding: 15px; border: 2px dashed #dee2e6; border-radius: 8px; background-color: #f8f9fa;">
                                            <div class="empty-state text-center text-muted py-4" id="invoice-empty-state">
                                                <i class="fa fa-arrow-up fa-2x mb-2"></i>
                                                <p class="mb-0">برای شروع، یک بخش اضافه کنید</p>
                                            </div>
                                        </div>
                                    ...
                                    <!-- Custom Text Input -->
                                    <div class="form-group" id="invoice-custom-text-group" style="display: none;">
                                        <label for="invoice-custom-text-input" class="font-weight-bold">
                                            <i class="fa fa-font"></i> متن سفارشی:
                                        </label>
                                        <input type="text" class="form-control form-control-lg" id="invoice-custom-text-input" placeholder="متن مورد نظر را وارد کنید (مثال: شرکت، پروژه و ...)">
                                        <small class="form-text text-muted">این متن در قالب شماره فاکتور نمایش داده می‌شود</small>
                                    </div>
                                </div>
                                ...
                                <!-- Action Buttons -->
                                <div class="d-flex justify-content-between align-items-center pt-3 border-top">
                                    <button type="button" class="btn btn-secondary" id="reset-invoice-format-btn">
                                        <i class="fa fa-redo"></i> بازنشانی
                                    </button>
                                    <button type="button" class="btn btn-success btn-lg" id="save-invoice-format-btn">
                                        <i class="fa fa-save"></i> ذخیره قالب
                                    </button>
                                </div>
                            </div>
...
$(document).ready(function() {
    ...
    // ========== INVOICE SETTINGS ==========
    var invoiceFormatParts = [];
    var invoiceFormatSeparators = [];
    var invoiceCustomText = '';
    var invoiceSortableInstance = null;
    ...
    function loadInvoiceSettings() {
        ...
        $.ajax({
            ...
            success: function(response) {
                if (response.data) {
                    var org = response.data;
                    if (org.invoice_number_format && org.invoice_number_format.parts) {
                        invoiceFormatParts = org.invoice_number_format.parts;
                        invoiceFormatSeparators = org.invoice_number_format.separators || [];
                        invoiceCustomText = org.invoice_number_format.custom_text || '';
            ...
            error: function(xhr) {
                console.error('Error loading invoice settings:', xhr);
            }
        });
    }
    
    // Render invoice format parts
    function renderInvoiceFormat() {
        var container = $('#invoice-format-parts-container');
        var emptyState = $('#invoice-empty-state');
        
        if (invoiceFormatParts.length > 0) {
            emptyState.hide();
        } else {
            emptyState.show();
        }
        ...
        invoiceFormatParts.forEach(function(part, index) {
            var config = partConfigs[part];
            if (!config) return;
            
            var partHtml = '<div class="format-part-item d-flex align-items-center" data-index="' + index + '" data-type="' + part + '">';
            partHtml += '<div class="d-flex align-items-center flex-grow-1">';
            partHtml += '<span class="badge ' + config.badgeClass + ' mr-2"><i class="fa ' + config.icon + '"></i> ' + config.label + '</span>';
            if (index < invoiceFormatParts.length - 1) {
                partHtml += '<select class="form-control separator-select ml-2" data-index="' + index + '">';
                partHtml += '<option value="/"' + (invoiceFormatSeparators[index] === '/' ? ' selected' : '') + '>/</option>';
                partHtml += '<option value="-"' + (invoiceFormatSeparators[index] === '-' ? ' selected' : '') + '>-</option>';
                partHtml += '</select>';
            }
            partHtml += '</div>';
            partHtml += '<button type="button" class="btn btn-sm btn-danger remove-invoice-part-btn" data-index="' + index + '">';
            partHtml += '<i class="fa fa-times"></i>';
            partHtml += '</button>';
            partHtml += '</div>';
        ...
        // Initialize Sortable for invoice format
        if (invoiceSortableInstance) {
            invoiceSortableInstance.destroy();
        }
        invoiceSortableInstance = Sortable.create(container[0], {
            animation: 150,
            handle: '.format-part-item',
            onEnd: function(evt) {
                var oldIndex = evt.oldIndex;
                ...
                // Move part
                var part = invoiceFormatParts.splice(oldIndex, 1)[0];
                invoiceFormatParts.splice(newIndex, 0, part);
                
                // Move separator
                if (oldIndex < invoiceFormatSeparators.length) {
                    var sep = invoiceFormatSeparators.splice(oldIndex, 1)[0];
                    invoiceFormatSeparators.splice(newIndex, 0, sep);
                }
        ...
        if (invoiceFormatParts.includes('text')) {
            $('#invoice-custom-text-group').show();
            $('#invoice-custom-text-input').val(invoiceCustomText);
        } else {
            $('#invoice-custom-text-group').hide();
        }
    ...
    function updateInvoicePreview() {
        ...
        if (invoiceFormatParts.length === 0) {
            $('#invoice-format-preview').html('<span class="text-muted">هیچ قالبی تعریف نشده است</span>');
            return;
        }
        
        invoiceFormatParts.forEach(function(part, index) {
            if (index > 0 && invoiceFormatSeparators[index - 1]) {
                preview += '<span class="separator-preview">' + invoiceFormatSeparators[index - 1] + '</span>';
            }
            ...
            switch(part) {
                ...
                case 'year':
                    ...
                    break;
                case 'text':
                    preview += '<span class="part-preview">' + (invoiceCustomText || 'متن') + '</span>';
                    break;
            }
        });
        
        $('#invoice-format-preview').html(preview);
    }
    
    // Add invoice format part
    function addInvoiceFormatPart(type) {
        invoiceFormatParts.push(type);
        if (invoiceFormatParts.length > 1) {
            invoiceFormatSeparators.push('/');
        }
        renderInvoiceFormat();
    }
    
    // Remove invoice format part
    function removeInvoiceFormatPart(index) {
        swal({
            title: 'آیا مطمئن هستید؟',
            text: 'این بخش از قالب حذف خواهد شد',
            type: 'warning',
            ...
            if (result.value) {
                invoiceFormatParts.splice(index, 1);
                if (index > 0 && index <= invoiceFormatSeparators.length) {
                    invoiceFormatSeparators.splice(index - 1, 1);
                } else if (invoiceFormatSeparators.length > 0) {
                    invoiceFormatSeparators.shift();
                }
                renderInvoiceFormat();
            }
        });
    ...
    // Reset invoice format
    function resetInvoiceFormat() {
        swal({
            title: 'آیا مطمئن هستید؟',
            text: 'تمام قالب فعلی پاک خواهد شد',
            type: 'warning',
            ...
            if (result.value) {
                invoiceFormatParts = [];
                invoiceFormatSeparators = [];
                invoiceCustomText = '';
                $('#invoice-custom-text-input').val('');
                renderInvoiceFormat();
            }
        });
    }
    ...
    $(document).on('click', '.add-invoice-part-btn', function() {
        var type = $(this).data('type');
        addInvoiceFormatPart(type);
    });
    
    $(document).on('click', '.remove-invoice-part-btn', function(e) {
        e.stopPropagation();
        var index = $(this).data('index');
        removeInvoiceFormatPart(index);
    });
    
    $(document).on('change', '#invoice-format-parts-container .separator-select', function() {
        var index = $(this).data('index');
        invoiceFormatSeparators[index] = $(this).val();
        updateInvoicePreview();
    });
    
    $('#invoice-custom-text-input').on('input', function() {
        invoiceCustomText = $(this).val();
        updateInvoicePreview();
    });
    
    $('#reset-invoice-format-btn').on('click', function() {
        resetInvoiceFormat();
    });
    
    // Save invoice format
    $('#save-invoice-format-btn').on('click', function() {
        var $btn = $(this);
        var originalText = $btn.html();
        ...
        if (invoiceFormatParts.includes('text') && !invoiceCustomText) {
            swal({
                title: 'خطا',
                text: 'لطفاً متن سفارشی را وارد کنید',
                type: 'error',
        ...
        $.ajax({
            url: '/api/organization/settings/invoice',
            type: 'POST',
            headers: {
                'Authorization': 'Bearer ' + token,
                'Content-Type': 'application/json'
            ...
            data: JSON.stringify({
                invoice_number_format: {
                    parts: invoiceFormatParts,
                    separators: invoiceFormatSeparators,
                    custom_text: invoiceCustomText
                }
            }),
            success: function(response) {
                $btn.prop('disabled', false).html(originalText);
                swal({
                    title: 'موفقیت',
                    text: response.message || 'قالب فاکتور با موفقیت ذخیره شد',
                    type: 'success',
                    padding: '2em',
                    timer: 2000
                });
