            ...
            html += `
                <tr>
                    ...
                    <td>
                        ...
                        <button class="btn btn-sm btn-success resend-checklist-btn mr-1" data-service-id="${service.id}" title="ارسال مجدد برگه سرویس">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-send"><line x1="22" y1="2" x2="11" y2="13"></line><polygon points="22 2 15 22 11 13 2 9 22 2"></polygon></svg>
                        </button>
                        <button class="btn btn-sm btn-primary print-pdf-btn mr-1" data-service-id="${service.id}" title="دانلود PDF برگه سرویس">
        ...
        let html = `
            <div class="service-details-section">
                ...
                <div class="info-grid">
                    ...
                    <div class="info-item">
                        <span class="info-label">دفعات بازدید لینک هماهنگی و برگه سرویس توسط مدیرساختمان</span>
