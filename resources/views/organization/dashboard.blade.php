...
$(document).ready(function() {
    ...
    function renderDashboardData(data) {
        ...
        // Set current month service statistics
        if (stats.current_month_services) {
            $('#current-month-services-total-overview').text(stats.current_month_services.total);
            $('#current-month-services-pending-overview').text(stats.current_month_services.pending);
            $('#current-month-services-assigned-overview').text(stats.current_month_services.assigned);
            $('#current-month-services-completed-overview').text(stats.current_month_services.completed);
            $('#current-month-services-expired-overview').text(stats.current_month_services.expired);
        }
