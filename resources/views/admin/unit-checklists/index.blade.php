...
@section('title', 'مدیریت چک لیست های واحد')
            ...
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 layout-spacing">
                <div class="widget widget-chart-one">
                    <div class="widget-heading">
                        <h5 class="">مدیریت چک لیست های واحد</h5>
                    </div>
                    <div class="widget-content">
                        @include('admin.components.datatable', [
                            'title' => 'چک لیست های واحد',
                            'apiUrl' => '/api/admin/unit-checklists',
                            'createButton' => true,
    ...
    <script>
        $(document).ready(function() {
            ...
            window.onShow = function(id) {
                $.ajax({
                    url: `/api/admin/unit-checklists/${id}`,
                    type: 'GET',
                    headers: {
            ...
            $('#saveChecklist').click(function() {
                ...
                const url = id ? `/api/admin/unit-checklists/${id}` : '/api/admin/unit-checklists';
            ...
            $('#confirmDelete').click(function() {
                ...
                $.ajax({
                    url: `/api/admin/unit-checklists/${currentChecklistId}`,
                    type: 'DELETE',
                    headers: {
                        'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content'),
                        'Authorization': 'Bearer ' + localStorage.getItem('admin_token')
